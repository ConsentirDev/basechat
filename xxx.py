...
icons = {
    "assistant": "https://raw.githubusercontent.com/consentirdev/basechat/2f685de7dffb583f2b2a89cb8ee8bc27bf5b1a40/img/assistant-done.svg",
    "user": "https://raw.githubusercontent.com/consentirdev/basechat/2f685de7dffb583f2b2a89cb8ee8bc27bf5b1a40/img/user-done.svg",
}
...
st.set_page_config(page_title="xxx.net", page_icon="✨", layout="wide")

welcome_messages = [
    "Hello! I'm XXX, an AI assistant designed to make your file metadata meaningful. Ask me anything!",
    "Hi! I'm XXX, an AI-powered assistant for extracting and explaining xxx data. How can I help you today?",
    "Hey! I'm XXX, your AI-powered guide to understanding the metadata in your files. What would you like to explore?",
    "Hi there! I'm XXX, an AI-powered tool built to help you make sense of your file metadata. How can I help you today?",
    "Hello! I'm XXX, an AI-driven tool designed to help you understand your files' metadata. What can I do for you?",
    "Hi! I'm XXX, an AI-driven assistant designed to make your data easy to understand. How can I help you today?",
    "Welcome! I'm XXX, an intelligent AI-powered tool for extracting and explaining xxx data. How can I assist you today?",
    "Hello! I'm XXX, your AI-powered guide for understanding xxx metadata. Ask me anything!",
    "Hi! I'm XXX, an intelligent AI assistant ready to help you understand your files' metadata. What would you like to explore?",
    "Hey! I'm XXX, an AI assistant for extracting and explaining file data. How can I help you today?",
]
...
with st.sidebar:
    ...
    image_url = (
        "https://raw.githubusercontent.com/consentirdev/basechat/main/img/Exifa.gif"
    )
...
for message in st.session_state.messages:
    with st.chat_message(message["role"], avatar=icons[message["role"]]):
        ...
        if message == st.session_state["messages"][0]:
            if st.button("How can I use xxx?"):
                show_video("")
st.sidebar.caption(
    "Built by [Jordan Parfoot](https://www.linkedin.com/in/jordan-parfoot/). Like this? [Hire us!](https://blackmountainai.com.au/)"
)

linkedin = "https://raw.githubusercontent.com/consentirdev/basechat/main/img/linkedin.gif"
topmate = "https://raw.githubusercontent.com/consentirdev/basechat/main/img/topmate.gif"
email = "https://raw.githubusercontent.com/consentirdev/basechat/main/img/email.gif"
newsletter = (
    "https://raw.githubusercontent.com/consentirdev/basechat/main/img/newsletter.gif"
)
share = "https://raw.githubusercontent.com/consentirdev/basechat/main/img/share.gif"
...
st.sidebar.caption(
    f"""
        <div style='display: flex; align-items: center;'>
            <a href = 'https://www.linkedin.com/in/jordan-parfoot'><img src='{linkedin}' style='width: 35px; height: 35px; margin-right: 25px;'></a>
            <a href = 'https://topmate.io/bmaidev><img src='{topmate}' style='width: 32px; height: 32px; margin-right: 25px;'></a>
            <a href = 'mailto:info@blackmountainai.com.au'><img src='{email}' style='width: 28px; height: 28px; margin-right: 25px;'></a>
            <a href = 'https://www.linkedin.com/build-relation/newsletter-follow?'><img src='{newsletter}' style='width: 28px; height: 28px; margin-right: 25px;'></a>
            <a href = 'https://www.kaggle.com/bmaidev'><img src='{share}' style='width: 28px; height: 28px; margin-right: 25px;'></a>
            
        </div>
        <br>
        <a href = 'https://xxx.betteruptime.com/'><img src='{uptime}'></a>
...
if prompt := st.chat_input(disabled=not replicate_api):
    ...
    with st.chat_message(
        "user",
        avatar="https://raw.githubusercontent.com/consentirdev/basechat/main/img/user.gif",
    ):
        st.write(prompt)
if st.session_state.follow_up:
    ...
    with st.chat_message(
        "assistant",
        avatar="https://raw.githubusercontent.com/consentirdev/basechat/main/img/assistant.gif",
    ):
